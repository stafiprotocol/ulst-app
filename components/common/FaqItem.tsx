...
export const FaqItem = (props: Props) => {
	...
	const { collapseOpenId } = useAppSelector((state) => state.app);
	...
	return (
		<div className="bg-[#6C86AD14] rounded-[.12rem]" id={id}>
			<div
			...
			>
				<div
					className="text-[#6C86AD] text-[.18rem] font-[1000] flex-1 leading-tight mr-[.12rem]"
					style={{
						maxLines: 2,
						overflow: 'hidden',
...

			{
				<Collapse in={collapsed}>
					<div className="mt-[.12rem] text-[#6C86AD] text-[.15rem] pb-[.16rem] px-[.24rem] break-word leading-normal">
						{props.children}
					</div>
				</Collapse>
			}
